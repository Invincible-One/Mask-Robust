...
class ConfounderDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.guidance_list is not None:
...
class CelebA(ConfounderDataset):
    ...
    def __init__(
        ...
        self._data_folder = os.path.join(self.root, self._base_folder, "img_align_celeba/img_align_celeba")   #_data_folder is where data points are kept
